...
const AntInput = ({ placeholder, className = '', ...props }) => (
  <input 
    ...
    className={`w-full px-3 py-1.5 text-sm bg-white border border-[#d9d9d9] rounded hover:border-[#1677ff] focus:border-[#1677ff] focus:ring-2 focus:ring-[#1677ff] focus:ring-opacity-20 outline-none transition-all disabled:bg-[#f5f5f5] disabled:text-gray-400 disabled:cursor-not-allowed disabled:hover:border-[#d9d9d9] ${className}`}
    {...props}
  />
);
...
const MaterialComprehensiveView = () => {
  ...
  const columns = [
    ...
    { title: '操作', dataIndex: 'action', render: () => <AntButton type="link" className="text-sm">编辑</AntButton> }
  ];
      ...
      <AntModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={modalMode === 'add' ? '新增物料大类' : '编辑物料大类'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          ...
          <div className="flex min-h-[40px]">
            ...
            <div className="w-[35%] p-2 flex items-center">
              <AntSelect value={formData.borrowable} onChange={(e) => setFormData({...formData, borrowable: e.target.value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} />
            </div>
          </div>
        </div>
        ...
        <div className="border border-[#e8e8e8] text-sm mb-4">
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center relative">
              <AntInput value={formData.mainCatCode} onChange={(e) => setFormData({...formData, mainCatCode: e.target.value})} placeholder="请输入编码" />
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            <div className="w-[15%] bg-[#fafafa] p-2 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">是否MIS加域/鉴定</div>
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center">
              <AntSelect value={formData.mis} onChange={(e) => setFormData({...formData, mis: e.target.value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} />
            </div>
            <div className="w-[15%] bg-[#fafafa] p-2 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">是否允许借用</div>
            <div className="w-[35%] p-2 flex items-center">
              <AntSelect value={formData.borrowable} onChange={(e) => setFormData({...formData, borrowable: e.target.value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} />
            </div>
          </div>
          <div className="flex min-h-[40px]">
            <div className="w-[15%] bg-[#fafafa] p-2 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">是否电脑配件</div>
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center">
              <AntSelect value={formData.pcPart} onChange={(e) => setFormData({...formData, pcPart: e.target.value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} />
            </div>
      ...
      <AntModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={modalMode === 'add' ? '新增型号' : '编辑型号'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center relative">
              <AntInput value={formData.brand} onChange={(e) => setFormData({...formData, brand: e.target.value})} placeholder="请选择品牌" />
              <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] cursor-pointer" />
            </div>
        ...
        <div className="border border-[#e8e8e8] text-sm mb-4">
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 flex items-center relative">
              <AntInput value={formData.model} onChange={(e) => setFormData({...formData, model: e.target.value})} placeholder="请选择型号" />
              <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] cursor-pointer" />
            </div>
          </div>
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
...
const OfficeWarehouseMappingView = () => {
  ...
  const [modalMode, setModalMode] = useState('add');
  const [isBatchModalOpen, setIsBatchModalOpen] = useState(false);
  const [formData, setFormData] = useState({ company: '', dept: '', office: '', warehouse: '', priority: '' });

  const handleAdd = () => {
    setModalMode('add');
    setFormData({ company: '', dept: '', office: '', warehouse: '', priority: '' });
    setIsModalOpen(true);
  };

  const handleEdit = (record) => {
    setModalMode('edit');
    setFormData({ company: record.company, dept: record.dept, office: record.office, warehouse: record.warehouse, priority: record.priority });
    setIsModalOpen(true);
  };
      ...
      <AntModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={modalMode === 'add' ? '新增映射' : '编辑映射'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center relative">
              <AntInput value={formData.company} onChange={(e) => setFormData({...formData, company: e.target.value})} placeholder="请选择公司" />
              <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] cursor-pointer" />
            </div>
            ...
            <div className="w-[35%] p-2 flex items-center relative">
              <AntInput value={formData.dept} onChange={(e) => setFormData({...formData, dept: e.target.value})} placeholder="请选择部门" />
              <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] cursor-pointer" />
            </div>
          </div>
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 flex items-center relative">
              <AntInput value={formData.warehouse} onChange={(e) => setFormData({...formData, warehouse: e.target.value})} placeholder="请选择仓库" />
              <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] cursor-pointer" />
            </div>
          </div>
          <div className="flex min-h-[40px]">
            <div className="w-[15%] bg-[#fafafa] p-2 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right"><span className="text-red-500 mr-1">*</span>优先级</div>
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center">
              <AntInput type="number" value={formData.priority} onChange={(e) => setFormData({...formData, priority: e.target.value})} placeholder="请输入优先级" />
            </div>
            <div className="w-[15%] bg-[#fafafa] p-2 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700"></div>
            <div className="w-[35%] p-2 flex items-center"></div>
          </div>
...
const PSNewEmployeeMappingView = () => {
  ...
  const [modalMode, setModalMode] = useState('add');
  const [isBatchModalOpen, setIsBatchModalOpen] = useState(false);
  const [formData, setFormData] = useState({ company: '', config: '', city: '', desc: '', qty: '', dept: '', priority: '' });

  const handleAdd = () => {
    setModalMode('add');
    setFormData({ company: '', config: '', city: '', desc: '', qty: '1', dept: 'MIS', priority: '1' });
    setIsModalOpen(true);
  };

  const handleEdit = (record) => {
    setModalMode('edit');
    setFormData({ company: record.company, config: record.config, city: record.city, desc: record.desc, qty: record.qty, dept: record.dept, priority: record.priority });
    setIsModalOpen(true);
  };
      ...
      <AntModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={modalMode === 'add' ? '新增映射' : '编辑映射'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 flex items-center relative">
              <AntInput value={formData.config} onChange={(e) => setFormData({...formData, config: e.target.value})} placeholder="请选择配置" />
              <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] cursor-pointer" />
            </div>
          </div>
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
      ...
      <AntModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={modalMode === 'add' ? '新增权限' : '编辑权限'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center relative">
              <AntInput value={formData.materialCat} onChange={(e) => setFormData({...formData, materialCat: e.target.value})} placeholder="请选择" />
              <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] cursor-pointer" />
            </div>
        ...
        <div className="border border-[#e8e8e8] text-sm mb-4">
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[80%] p-2 flex items-center relative">
              <AntInput value={formData.company} onChange={(e) => setFormData({...formData, company: e.target.value})} placeholder="请选择" className="max-w-[300px]" />
      ...
      <AntModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="仓库信息" width="850px">
        ...
        <div className="border border-[#e8e8e8] text-sm mb-4">
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[38px]">
            ...
            <div className="w-[15%] bg-[#fafafa] p-1.5 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">是否启用库区</div>
            <div className="w-[35%] p-1.5 flex items-center gap-4 px-3">
              <AntRadio checked={formData.isAreaEnabled === '1'} onChange={() => setFormData({...formData, isAreaEnabled: '1'})} label="是" />
              <AntRadio checked={formData.isAreaEnabled === '0'} onChange={() => setFormData({...formData, isAreaEnabled: '0'})} label="否" />
            </div>
          </div>
          <div className="flex border-b border-[#e8e8e8] min-h-[38px]">
            <div className="w-[15%] bg-[#fafafa] p-1.5 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">是否启用库位</div>
            <div className="w-[35%] p-1.5 border-r border-[#e8e8e8] flex items-center gap-4 px-3">
              <AntRadio checked={formData.isLocationEnabled === '1'} onChange={() => setFormData({...formData, isLocationEnabled: '1'})} label="是" />
              <AntRadio checked={formData.isLocationEnabled === '0'} onChange={() => setFormData({...formData, isLocationEnabled: '0'})} label="否" />
            </div>
          ...
          <div className="flex min-h-[38px]">
            <div className="w-[15%] bg-[#fafafa] p-1.5 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">启用日期</div>
            <div className="w-[35%] p-1.5 border-r border-[#e8e8e8] flex items-center">
              <AntInput type="date" value={formData.startDate} onChange={(e) => setFormData({...formData, startDate: e.target.value})} className="text-gray-500" />
            </div>
            <div className="w-[15%] bg-[#fafafa] p-1.5 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">停用日期</div>
            <div className="w-[35%] p-1.5 flex items-center">
              <AntInput type="date" value={formData.endDate} onChange={(e) => setFormData({...formData, endDate: e.target.value})} className="text-gray-500" />
            </div>
          </div>
        </div>
      </AntModal>
...
const DeptCostCenterMappingView = () => {
  ...
  const data = [
    { id: 1, hrDept: 'D0177', hrDeptDesc: '搜狐媒体_大沟通', costCenter: '111001', costCenterDesc: 'BD_大沟通', enabled: true, startDate: '2010-01-01', endDate: '2013-12-31' },
  ];
...
const DeptBusinessLineMappingView = () => {
  ...
  const data = [
    { id: 1, hrDept: 'D2307', hrDeptDesc: '焦点房地产资讯', businessLine: 'F601', businessLineDesc: '石家庄', enabled: true, startDate: '2015-01-01', endDate: '' },
  ];
...
const ExpenseAccountRuleView = () => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [modalMode, setModalMode] = useState('add');
  const [formData, setFormData] = useState({ inCat: '', inComp: '', inCost: '', outComp: '', outPlate: '', outCost: '', outSubj: '', outSubSubj: '', outLine: '', outProj: '', enabled: '1' });

  const handleAdd = () => {
    setModalMode('add');
    setFormData({ inCat: '', inComp: '', inCost: '', outComp: '', outPlate: '', outCost: '', outSubj: '', outSubSubj: '', outLine: '', outProj: '', enabled: '1' });
    setIsModalOpen(true);
  };

  const handleEdit = (record) => {
    setModalMode('edit');
    setFormData({ inCat: record.inCat || '', inComp: record.inComp || '', inCost: record.inCost || '', outComp: record.outComp || '', outPlate: record.outPlate || '', outCost: record.outCost || '', outSubj: record.outSubj || '', outSubSubj: record.outSubSubj || '', outLine: record.outLine || '', outProj: record.outProj || '', enabled: record.enabled ? '1' : '0' });
    setIsModalOpen(true);
  };
  ...
  const data = [
    { id: 1, inCat: '16.FURNITURE', inComp: '114_新媒体', inCost: '112064', outComp: '', outPlate: '17_Corporate', outCost: '909003', outSubj: '', outSubSubj: '', outLine: '', outProj: '', enabled: true },
  ];
      ...
      <AntModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={modalMode === 'add' ? '新增费用账户规则' : '编辑费用账户规则'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center">
              <AntInput value={formData.inCat} onChange={(e) => setFormData({...formData, inCat: e.target.value})} />
            </div>
            <div className="w-[15%] bg-[#fafafa] p-2 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">公司(输入)</div>
            <div className="w-[35%] p-2 flex items-center relative">
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center">
              <AntInput value={formData.inCost} onChange={(e) => setFormData({...formData, inCost: e.target.value})} />
            </div>
            <div className="w-[15%] bg-[#fafafa] p-2 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">公司(输出)</div>
            <div className="w-[35%] p-2 flex items-center relative">
