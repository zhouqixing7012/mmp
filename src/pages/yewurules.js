...
import { Button, Input, Select, Modal, Table, Radio, Card, Tag } from 'antd';
        ...
        <div className="mb-4">
          ...
          <div className="border border-t-0 border-[#e8e8e8] text-sm">
            ...
            <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 flex items-center">
                <Input value={formData.subCatDesc} onChange={(e) => setFormData({...formData, subCatDesc: e.target.value})} placeholder="请选择" />
              ...
              <div className="w-[37.5%] p-2 flex items-center relative cursor-pointer" onClick={() => setIsBrandModalOpen(true)}>
                <Input value={formData.brand} onChange={(e) => setFormData({...formData, brand: e.target.value})} placeholder="请选择品牌" readOnly className="pointer-events-none" />
                <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] pointer-events-none" />
              </div>
            </div>
            <div className="flex min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center relative cursor-pointer" onClick={() => setIsModelModalOpen(true)}>
                <Input value={formData.modelCode} onChange={(e) => setFormData({...formData, modelCode: e.target.value})} placeholder="请选择" readOnly className="pointer-events-none" />
                <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] pointer-events-none" />
              </div>
              ...
              <div className="w-[37.5%] p-2 flex items-center relative cursor-pointer" onClick={() => setIsConfigModalOpen(true)}>
                <Input value={formData.configDesc} onChange={(e) => setFormData({...formData, configDesc: e.target.value})} placeholder="请选择" readOnly className="pointer-events-none" />
                <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1677ff] pointer-events-none" />
              </div>
            </div>
          </div>
        ...
        <div className="mb-4">
          ...
          <div className="border border-t-0 border-[#e8e8e8] text-sm">
            <div className="flex min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.enabled} onChange={(value) => setFormData({...formData, enabled: value})} options={[{label:'启用', value:'1'}, {label:'停用', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
        ...
        <div className="mb-4">
          ...
          <div className="border border-t-0 border-[#e8e8e8] text-sm">
            ...
            <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.unit} onChange={(value) => setFormData({...formData, unit: value})} options={[{label:'台', value:'台'}, {label:'块', value:'块'}, {label:'个', value:'个'}, {label:'套', value:'套'}, {label:'件', value:'件'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.returnCheck} onChange={(value) => setFormData({...formData, returnCheck: value})} options={[{label:'MIS', value:'MIS'}, {label:'ES', value:'ES'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
            </div>
            <div className="flex min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.misAudit} onChange={(value) => setFormData({...formData, misAudit: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
        ...
        <div className="mb-4">
          ...
          <div className="border border-t-0 border-[#e8e8e8] text-sm">
            <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.canApply} onChange={(value) => setFormData({...formData, canApply: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.isStop} onChange={(value) => setFormData({...formData, isStop: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
            </div>
            <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.needCheck} onChange={(value) => setFormData({...formData, needCheck: value})} options={[{label:'是', value:'是'}, {label:'否', value:'否'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.allowReplace || '0'} onChange={(value) => setFormData({...formData, allowReplace: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
            </div>
            <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.allowTransfer || '1'} onChange={(value) => setFormData({...formData, allowTransfer: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.allowBorrow || '0'} onChange={(value) => setFormData({...formData, allowBorrow: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
            </div>
            <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
              ...
              <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                <Select value={formData.needEsApproval || '0'} onChange={(value) => setFormData({...formData, needEsApproval: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
              ...
              <div className="w-[37.5%] p-2 flex items-center">
                <Select value={formData.allowReturn || '0'} onChange={(value) => setFormData({...formData, allowReturn: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="mb-4">
            ...
            <div className="border border-t-0 border-[#e8e8e8] text-sm">
              <div className="flex min-h-[40px]">
                ...
                <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                  <Select value={formData.nonTechOverlimit || '0'} onChange={(value) => setFormData({...formData, nonTechOverlimit: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
                </div>
                ...
                <div className="w-[37.5%] p-2 flex items-center">
                  <Select value={formData.misIdentifyOnReturn || '0'} onChange={(value) => setFormData({...formData, misIdentifyOnReturn: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="border border-t-0 border-[#e8e8e8] text-sm">
              <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
                ...
                <div className="w-[37.5%] p-2 border-r border-[#e8e8e8] flex items-center">
                  <Select value={formData.misIdentify || '0'} onChange={(value) => setFormData({...formData, misIdentify: value})} options={[{label:'是', value:'1'}, {label:'否', value:'0'}]} placeholder="请选择" allowClear className="w-full" />
                </div>
              </div>
              <div className="flex min-h-[40px]">
      ...
      <Modal open={isModalOpen} onCancel={() => setIsModalOpen(false)} footer={null} title="仓库信息" width="850px">
        ...
        <div className="border border-[#e8e8e8] text-sm mb-4">
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[38px]">
            ...
            <div className="w-[35%] p-1.5 border-r border-[#e8e8e8] flex items-center">
              <Select value={formData.floor} onChange={(value) => setFormData({...formData, floor: value})} options={[]}  placeholder="请选择" allowClear />
            </div>
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[38px]">
            ...
            <div className="w-[35%] p-1.5 border-r border-[#e8e8e8] flex items-center">
              <Select value={formData.type} onChange={(value) => setFormData({...formData, type: value})} options={[]}  placeholder="请选择" allowClear />
            </div>
          ...
          <div className="flex min-h-[38px]">
            ...
            <div className="w-[35%] p-1.5 border-r border-[#e8e8e8] flex items-center gap-4 px-3">
              <Radio checked={formData.isVirtual === '1'} onChange={() => setFormData({...formData, isVirtual: '1'})} label="是" />
              <Radio checked={formData.isVirtual === '0'} onChange={() => setFormData({...formData, isVirtual: '0'})} label="否" />
            </div>
            ...
            <div className="w-[35%] p-1.5 flex items-center gap-4 px-3">
              <Radio checked={formData.isEnabled === '1'} onChange={() => setFormData({...formData, isEnabled: '1'})} label="是" />
              <Radio checked={formData.isEnabled === '0'} onChange={() => setFormData({...formData, isEnabled: '0'})} label="否" />
            </div>
          </div>
        </div>
      </Modal>
...
const WarehousePermissionView = () => {
  ...
  const columns = [
    ...
    { title: '盘点权限', dataIndex: 'invPerm', render: (val) => <StatusTag value={val} /> },
    { title: '操作', dataIndex: 'action', render: (_, record) => <Button type="link" onClick={() => handleEdit(record)}>编辑</Button> }
  ];
      ...
      <Modal open={isModalOpen} onCancel={() => setIsModalOpen(false)} footer={null} title={modalMode === 'add' ? '新增成本中心与科目映射' : '编辑成本中心与科目映射'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 flex items-center">
              <Input value={formData.costCenterDesc} onChange={(e) => setFormData({...formData, costCenterDesc: e.target.value})} />
            </div>
          </div>
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 flex items-center">
              <Input value={formData.subjectDesc} onChange={(e) => setFormData({...formData, subjectDesc: e.target.value})} />
            </div>
          </div>
          <div className="flex min-h-[40px]">
      ...
      <Modal open={isModalOpen} onCancel={() => setIsModalOpen(false)} footer={null} title={modalMode === 'add' ? '新增物料大类与子目映射' : '编辑物料大类与子目映射'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 flex items-center">
              <Input value={formData.subSubjDesc} onChange={(e) => setFormData({...formData, subSubjDesc: e.target.value})} />
            </div>
          </div>
          <div className="flex min-h-[40px]">
            <div className="w-[15%] bg-[#fafafa] p-2 border-r border-[#e8e8e8] flex items-center justify-end font-medium text-gray-700 text-right">是否启用</div>
      ...
      <Modal open={isModalOpen} onCancel={() => setIsModalOpen(false)} footer={null} title={modalMode === 'add' ? '新增NO一级服务与科目映射' : '编辑NO一级服务与科目映射'} width="900px">
        <div className="border border-[#e8e8e8] text-sm mb-4">
          ...
          <div className="flex border-b border-[#e8e8e8] min-h-[40px]">
            ...
            <div className="w-[35%] p-2 border-r border-[#e8e8e8] flex items-center">
              <Input value={formData.plateDesc} onChange={(e) => setFormData({...formData, plateDesc: e.target.value})} />
            </div>
