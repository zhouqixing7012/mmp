...
export const MATERIAL_OPTIONS = [
  ...
  { id: 3, purchaseType: '低耗耗材', code: '114010002000201', name: '网线.六类.2米', config: 'CAT6 / 2m / 蓝色' },
  { id: 4, purchaseType: '低耗耗材', code: '114010002000202', name: '鼠标垫.标准款', config: '黑色 / 300×250mm' },
];

export const INITIAL_PO_ROWS = [
  {
    id: 1, poNo: 'PO2609010001', receiptStatus: '待接收', poName: '办公低值耐用品采购订单',
    company: '114.新媒体', plate: '集团', officeArea: '北京 - 搜狐网络大厦', supplier: '北京一新科技有限责任公司',
    supplierPhone: '010-62728001', procurementUnit: '114.新媒体', procurementUnitPhone: '010-62728002',
    contractSubject: '北京搜狐新媒体信息技术有限公司', buyer: '114664.薛毛毛', buyerPhone: '010-62728109',
    pushDate: '2026-09-01', purchaseType: '低值耐用品', applicationBatch: 'BAT-20260901-01',
  },
  {
    id: 2, poNo: 'PO2609020002', receiptStatus: '待接收', poName: '办公低耗耗材采购订单',
    company: '114.新媒体', plate: '集团', officeArea: '北京 - 融科大厦 C 座', supplier: '北京荣泽嘉业商贸有限公司',
    supplierPhone: '010-62728003', procurementUnit: '114.新媒体', procurementUnitPhone: '010-62728002',
    contractSubject: '北京搜狐新媒体信息技术有限公司', buyer: '115102.王英', buyerPhone: '010-62728110',
    pushDate: '2026-09-02', purchaseType: '低耗耗材', applicationBatch: 'BAT-20260902-02',
  },
  {
    id: 3, poNo: 'PO2608200004', receiptStatus: '已入库', poName: '会议室日常耗材采购订单',
    company: '116.天津飞狐', plate: '视频', officeArea: '北京 - 融科大厦 A 座', supplier: '北京美捷美科技有限公司',
    supplierPhone: '010-62728007', procurementUnit: '116.天津飞狐', procurementUnitPhone: '010-62728008',
    contractSubject: '天津飞狐信息技术有限公司', buyer: '116201.李明', buyerPhone: '010-62728111',
    pushDate: '2026-08-20', purchaseType: '低耗耗材', applicationBatch: 'BAT-20260820-04',
  },
];
...
export const INITIAL_PO_ITEMS = {
  ...
  PO2609020002: [
    {
      id: 1, receiptStatus: '待接收', materialGroup: '低耗耗材', assetClass: '办公耗材', materialCode: '114010002000201',
    ...
    {
      id: 2, receiptStatus: '待接收', materialGroup: '低耗耗材', assetClass: '办公耗材', materialCode: '114010002000202',
  ...
  PO2608200004: [
    {
      id: 1, receiptStatus: '已入库', materialGroup: '低耗耗材', assetClass: '办公耗材', materialCode: '116010002000301',
...
export const INITIAL_RECEIPTS = [
  {
    id: 1, receiptNo: 'REC-202608210001', status: '接收完成', poNo: 'PO2608200004', poName: '会议室日常耗材采购订单',
    supplier: '北京美捷美科技有限公司', supplierPhone: '010-62728007', procurementUnit: '116.天津飞狐', buyer: '116201.李明',
    buyerPhone: '010-62728111', contractSubject: '天津飞狐信息技术有限公司', plate: '视频', receiver: '115102-王英',
    createdAt: '2026-08-21 15:32:09', applicationBatch: 'BAT-20260820-04', purchaseType: '低耗耗材', details: [],
    lines: [{
      id: 1, sourceItemId: 1, materialGroup: '低耗耗材', assetClass: '办公耗材', materialCode: '116010002000301', materialDesc: '白板笔.黑色',
    ...
    inboundResult: { inboundNo: 'IN-202608210001', warehouse: '天津耗材仓', status: '已完成', creator: '115102-王英', createdAt: '2026-08-21', quantity: 50 },
  },
];
