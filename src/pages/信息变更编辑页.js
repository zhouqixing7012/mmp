                      ...
                      <td className="py-3 px-4 align-middle">
                        ...
                        >
                          {hasChildren ? (
                            ...
                            >
                              {asset.expanded ? <IconChevronDown size={14} /> : <IconChevronRight size={14} />}
                            </button>
                          ) : (
                        ...
                        {asset.relation === '备' ? (
                          ...
                          <div className="relative group cursor-pointer" onClick={() => openLocationModal(asset)}>
                            <input 
                              ...
                              placeholder="请选择"
                            />
                            <IconSearch size={14} className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-blue-500 transition-colors" />
                          </div>
                        )}
                      </td>
          ...
          <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center transition-opacity">
            <div className="bg-white rounded-lg shadow-xl w-[420px] overflow-hidden transform transition-all">
              <div className="flex justify-between items-center px-5 py-4 border-b border-gray-100 bg-gray-50/80">
                ...
                <IconX size={18} className="text-gray-400 hover:text-gray-600 cursor-pointer transition-colors" onClick={closeLocationModal} />
              </div>
