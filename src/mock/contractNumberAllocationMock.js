export const CONTRACT_NUMBER_ALLOCATION_STORAGE_KEY = 'mmp.contractNumberAllocation.applications.v5';
...
export const DEFAULT_CONTRACT_NUMBER_ALLOCATION_APPLICATIONS = [
  ...
  {
    id: 'PCMFL202409100002',
    status: '待审批',
    currentNode: '合约号码配给主管审批',
    applicant: {
      id: '219319',
      name: '王天明',
      department: '视频产品技术中心/互动技术部',
    ...
    idCard: '220***********2079',
    attachment: DEMO_ATTACHMENT,
    assignedNumber: CONTRACT_NUMBER_CANDIDATES[0],
    ...
    history: [
      ...
      {
        id: 'supervisor-demo-history-3',
        person: '孙志强(213852)',
        node: 'ES审批',
        time: '2024-09-10 15:20:00',
        status: '已同意',
        comment: '同意',
      },
      {
        id: 'supervisor-demo-history-4',
        person: '配给主管',
        node: '合约号码配给主管审批',
        time: '',
        status: '待审批',
