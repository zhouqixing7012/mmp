...
- 2026-08-28 新员工领用“使用人信息”删除领用单号与备注，制单时间调整到使用人之后、单据状态之前，并保留 City 起始行不前移；“领用物资明细”删除物资总类和操作列，“大类”改为“资产大类”并新增“资产小类”；资产标签号选择弹窗补充横向滚动，修正末列“所在仓库”超出弹窗内容宽度时的背景显示异常。
...
- 新员工领用页已按最新使用人信息与领用物资明细字段口径同步，资产选择弹窗横向溢出问题已处理。
