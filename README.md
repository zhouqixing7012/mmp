...
资产管理的跨公司转移、资产报废和账面报废已统一“单号看详情、查看进度看审批记录”的入口。资产报废演示机房和办公设备两类草稿；账面报废创建时选择调账或非调账，并展示对应的公司间转移明细或资产明细。
资产处置同样采用申请单列表：办公设备由人员手动创建，机房资产以及软件、丢失类无实物处置单随账面报废执行自动生成；审批页按 City 和资产大类汇总。
