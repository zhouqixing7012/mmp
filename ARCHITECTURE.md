...
| `src/pages/inventoryManagement/MoveMobilePrototype.jsx` | `/inventory/move/mobile` 独立移动端移库原型；演示仓库选择、发起/接收、草稿、扫码验证、接收、驳回和快捷扫码。 |
| `src/pages/inventoryManagement/moveMobilePrototype.css` | 移库移动端原型的窄屏布局、卡片、底部操作区和选择抽屉样式。 |
